...
DE_RULES = (DEFAULT_RULES + 
            ...
            suffix_rules(_lang, ['st','t','te','tem','ten','ter','tes','tet'], constraint_regex='([bfghklmnprsxzß]|au|eu|ei)$') +
            suffix_rules(_lang, ['est','et','ete','etem','eten','eter','etes','etet'], constraint_regex='([dt]|[bdfhkg][mn])$') +
